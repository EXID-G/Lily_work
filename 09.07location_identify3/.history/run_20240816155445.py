...
def runFiles(    rawData_dir,    outputFolder_name,    remove_words=["建设","新建","高峰","前进","公安","海湾","楼下","西边","中村"]    ):
    ...
    print(f"Files are prepared. Your raw files are in the {rawData_dir}")
    print(f"Your final `.csv` files will be saved in the following folders: {outputFolder_combine}")
